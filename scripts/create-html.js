...
// Create index.html for Netlify deployment
...
<head>
  ...
  ${manifestJs ? `<script src="/assets/${manifestJs}"></script>` : ''}
  ${rootCss ? `<link rel="stylesheet" href="/assets/${rootCss}" />` : ''}
  
  <title>RealtyVibe - Premium Real Estate</title>
</head>
<body>
  <div id="root"></div>
  ${entryClient ? `<script type="module" src="/assets/${entryClient}"></script>` : ''}
</body>
</html>`;
...
console.log('Created index.html and 404.html for Netlify deployment');